...
func TestGet(t *testing.T) {
	...
	tt := []struct {
		...
		// (match)
		{give: `{"a_b":3,"a_c":4,"b_c":5}`, when: `(iterate (match "_c" -s) (this))`, then: `{"a_c":4,"b_c":5}`},
		...
		{give: `{"a":{"a":3,"b":4,"c":5},"b":{"a":6,"b":7,"c":8},"c":9}`, when: `(iterate (!= (this) "c") (this))`, then: `{"a":{"a":3,"b":4},"b":{"a":6,"b":7}}`},
		...
		{give: `{"a":3}`, when: `(iterate (if (== (key) "a") (nothing)) (this))`, then: `{}`},
		...
		{give: `{"a":[{"b":{"c":3}},{"b":{}}]}`, when: `a (last (== (get b c) 3) b c)`, then: `3`},
		{give: `{"a":[{"b":{"c":3}},{"b":{}}]}`, when: `a (first (== (get b c) 3) b c)`, then: `3`},
		{give: `{"a":[{"b":3},{"b":4}]}`, when: `a (last) b`, then: `4`},
		{give: `{"a":[{"b":3},{"b":4}]}`, when: `a (first) b`, then: `3`},
		{give: `[{"a":3,"b":1},{"a":4,"b":2},{"a":4,"b":3},{"a":5,"b":4}]`, when: `(last  (== a 4) b)`, then: `3`},
		{give: `[{"a":3,"b":1},{"a":4,"b":2},{"a":4,"b":3},{"a":5,"b":4}]`, when: `(first (== a 4) b)`, then: `2`},
		{give: `[{"a":3,"b":1},{"a":4,"b":2},{"a":4,"b":3},{"a":5,"b":4}]`, when: `(last  (== a 4))`, then: `{"a":4,"b":3}`},
		{give: `[{"a":3,"b":1},{"a":4,"b":2},{"a":4,"b":3},{"a":5,"b":4}]`, when: `(first (== a 4))`, then: `{"a":4,"b":2}`},
